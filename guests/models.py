...
class Guest(models.Model):
    ...
    def whatsapp_message(self):
        ...
        INVITATION_SMS_TEMPLATE = 'Hi *_{0}_*. Siddharth and Shreya are tying the knot on 8th Jan. We would love to have you bless us with your presence. Kindly click on this link for your invitation here {1}'
