...
from guests.views import GuestListView, test_email, save_the_date_preview, save_the_date_random, export_guests, \
    invitation, invitation_email_preview, invitation_email_test, rsvp_confirm, dashboard, find_my_invite
...
urlpatterns = [
    ...
    url(r'^find-my-invite/$', find_my_invite, name='find-my-invite'),
